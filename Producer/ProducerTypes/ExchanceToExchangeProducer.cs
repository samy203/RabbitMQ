...
{
    internal class ExchangeToExchangeProducer : BaseProducer
    {
        public ExchangeToExchangeProducer()
        {
            MediumName = "initial-exchange";
            Configure();
        }
        ...
        public void Configure()
        {
            ...
            Channel.ExchangeBind("final-exchange", MediumName, "");
        }
